    ...
    if(empty($data_missing)){
        ...
        $affected_rows = mysqli_stmt_affected_rows($stmt);
			if($affected_rows == 1){
				...
				echo 'Error Occurred<br>'.mysqli_error($dbc);
				mysqli_stmt_close($stmt);
				mysqli_close($dbc);
			}
    } else {
...
?>
	<p><a href="http://localhost/projectlearn/website/addstudent.php"><b>ADD New Studdent</b></a></p>
	<p><a href="http://localhost/projectlearn/website/getstudentinfo.php"><b>Get Studdent Info</b></a></p>
	<!-- <form action="http://localhost/projectlearn/studentadded.php" method="post">
