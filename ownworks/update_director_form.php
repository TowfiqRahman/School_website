            ...
            <div class="bg-dark dk" id="wrap" style="padding-bottom:50px;">
                <div id="top">
					...
					<header class="head">
                            ...
                            <div class="main-bar">
                                <h3>
									<center><i class="fa fa-square-o"></i>&nbsp;Update Director  Info</center>
                                </h3>
                            </div>
                            <!-- /.main-bar -->
                        </header>
...
<div class="container">
	<form class="form-horizontal" action="update_director_process.php" method="post">
		<h3><p class="text-info" style="padding: 30px ">Update Director data</br></p></h3>
		...
		<div class="form-group">
		  <label class="control-label col-sm-2" for="Position"> Director Position:</label>
		  <div class="col-sm-6">
			  <input type="text" class="form-control" id="Position" placeholder="Enter Director Position" name="Position" required>
		  </div>
		</div>
