...
if(isset($_POST['submit'])){
		...
		//echo 'submit success';
	$query = "SELECT * FROM supervision where $col  LIKE '%$value%' ";
		...
		<div class="table-responsive">
				...
				<thead>
				  <tr class="active" >
					...
					<td align="center"><b>Director Name</b></td>
					<td align="center"><b>Director Position</b></td>
				  </tr>
				</thead>';
		...
		while($row = mysqli_fetch_array($response)){
			...
			echo '<tbody>
					<tr class="">
					  ...
					  <td align="center">' . $row['director_name'] . '</td>
