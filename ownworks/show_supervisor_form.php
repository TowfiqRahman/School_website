            ...
            <div class="bg-dark dk" id="wrap" style="padding-bottom:50px;">
                <div id="top">
					...
					<header class="head">
                            ...
                            <div class="main-bar">
                                <h3>
									<center><i class="fa fa-square-o"></i>&nbsp;Show Supervisor Info </center>
                                </h3>
                            </div>
                            <!-- /.main-bar -->
                        </header>
...
// If the query executed properly proceed
	if($response){
		...
		<div class="table-responsive">
				...
				<thead>
				  <tr class="active" >
					...
					<th align="center"><b>Director Name</b></th>
					<th align="center"><b>Director Position</b></th>
		...
		while($row = mysqli_fetch_array($response)){
			...
			echo '<tbody>
					<tr class="">
					  <td align="left">' . $row['teacher_id'] . '</td>
					  <td align="left">' . $row['director_name'] . '</td>
					  <td align="left">' . $row['position'] . '</td>';
					  ?>
					  <td><a href="delete_supervisor.php?id=<?php echo $row['teacher_id'];?>" class="btn btn-danger">Delete</button></a></td>
					  <td><a href="update_supervisor_form1.php?id=<?php echo $row['teacher_id']?>"><button type="button" class="btn btn-info">Update</button></a></td>
					</tr>
				</tbody>
				<?php
		}
