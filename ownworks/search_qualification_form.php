            ...
            <div class="bg-dark dk" id="wrap" style="padding-bottom:50px;">
                <div id="top">
					...
					<header class="head">
                            ...
                            <div class="main-bar">
                                <h3>
									<center><i class="fa fa-square-o"></i>&nbsp;Search Qualification Info</center>
                                </h3>
                            </div>
                            <!-- /.main-bar -->
                        </header>
...
<div class="container">
	<form class="form-horizontal" action="search_qualification_process.php" method="post">
		
				<h3><p class="text-info"style="padding:30px">Search Teacher Qualification</p></h3>
		...
		<div class="form-group">
		  ...
		  <select class="form-control"name="$column" id="$column">
			<option value="teach_id">Teacher Id</option>
