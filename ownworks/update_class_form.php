...
<div class="container">
	...
	<h3><p class="text-info"style="padding:30px">Update Class data
								</p></h3>
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-6">
			  <input type="text" class="form-control" id="classno" placeholder="Enter Class 1,2,.." name="classno" required>
		  </div>
		</div>
		<div class="form-group">
