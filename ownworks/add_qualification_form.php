            ...
            <div class="bg-dark dk" id="wrap" style="padding-bottom:50px;">
                <div id="top">
					...
					<header class="head">
                            ...
                            <div class="main-bar">
                                <h3>
									<center><i class="fa fa-square-o"></i>&nbsp;Add  Qualification Info </center>
                                </h3>
                            </div>
                            <!-- /.main-bar -->
                        </header>
                    ...
                    <div class="outer">
                        <div class="inner bg-light lter">
                            <div class="container">
								...
								<form class="form-horizontal" action="add_qualification_process.php" method="post">
									...
									<div class="form-group">
									  ...
									  <div class="col-sm-6">
										  <input type="text" class="form-control" id="Qualification" placeholder="Enter Qualification M.A. B. Ed." name="Qualification" required>
									  </div>
									</div>
