            ...
            <div class="bg-dark dk" id="wrap" style="padding-bottom:50px;">
                <div id="top">
					...
					<header class="head">
                            ...
                            <div class="main-bar">
                                <h3>
									<center><i class="fa fa-square-o"></i>&nbsp;Add  Teacher Qualification Info </center>
                                </h3>
                            </div>
                            <!-- /.main-bar -->
                        </header>
...
if(isset($_POST['submit'])){
        ...
        $query = "INSERT INTO teacher_qualification (teach_id, qualification)VALUES ('$id', '$Qualification')";
