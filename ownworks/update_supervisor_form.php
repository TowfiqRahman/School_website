            ...
            <div class="bg-dark dk" id="wrap" style="padding-bottom:50px;">
                <div id="top">
					...
					<header class="head">
                            ...
                            <div class="main-bar">
                                <h3>
									<center><i class="fa fa-square-o"></i>&nbsp;Update Supervisor  Info</center>
                                </h3>
                            </div>
                            <!-- /.main-bar -->
                        </header>
...
<div class="container">
	<form class="form-horizontal" action="update_supervisor_process.php" method="post">
		<h3><p class="text-info" style="padding: 30px ">Update Supervisor data</br></p></h3>
		
		<div class="form-group">
		  <label class="control-label col-sm-2" for="id">Teacher ID: </label>
		  <div class="col-sm-6">
			  <input type="text" class="form-control" id="id" placeholder="Enter Teacher ID" name="id" required>
		  </div>
		</div>
		
		<div class="form-group">
		  <label class="control-label col-sm-2" for="name">Director Name:</label>
		  <div class="col-sm-6">
			  <input type="text" class="form-control" id="name" placeholder="Enter Director Name" name="name" required>
		  </div>
		</div>
		...
		<div class="form-group">
		  ...
		  <select class="form-control"name="$column" id="$column">
			...
			<option value="position">Director Position</option>
		  </select>
		  </div>
		</div>
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-6">
			  <input type="text" class="form-control" id="$stu_value" placeholder="Enter Updated Data" name="$stu_value" required>
		  </div>
		</div>
