...
if(isset($_POST['submit'])){
        $id          = validate_input($_POST['t_id']);
        $f_name      = validate_input($_POST['f_name']);
        $l_name      = validate_input($_POST['l_name']);
        $sex         = validate_input($_POST['sex']);
        $relation = validate_input($_POST['relation']);
        
        $query = "INSERT INTO dependents (t_id, f_name, l_name, sex,
        relation)VALUES ('$id', '$f_name', '$l_name', '$sex',
        '$relation')";
