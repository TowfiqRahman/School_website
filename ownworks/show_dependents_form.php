            ...
            <div class="bg-dark dk" id="wrap" style="padding-bottom:50px;">
                <div id="top">
					...
					<header class="head">
                            <div class="main-bar">
                                <h3>
									<center><i class="fa fa-square-o"></i>&nbsp;Show Dependents Info </center>
                                </h3>
                            </div>
                            <!-- /.main-bar -->
                        </header>
...
// If the query executed properly proceed
	if($response){
		...
		while($row = mysqli_fetch_array($response)){
			...
			echo '<tbody>
					<tr class="">
					  <td align="left">' . $row['t_id'] . '</td>
					  <td align="left">' . $row['f_name'] . '</td>
					  <td align="left">' . $row['l_name'] . '</td>
					  <td align="left">' . $row['sex'] . '</td>
					  <td align="left">' . $row['relation'] . '</td>';
					?>
					<td><a href="delete_dependents.php?id=<?php echo $row['t_id'];?>"><button type="button" class="btn btn-danger">Delete</button></a></td>
					  <td><a href="update_dependents_form1.php?id=<?php echo $row['t_id']?>"><button type="button" class="btn btn-info">Update</button></a></td>
					</tr>
				</tbody>
				<?php
		}
