...
if(isset($_POST['submit'])){
        ...
        $totalnum     = validate_input($_POST['totalnum']);
        $sid   = validate_input($_POST['sid']);
        $tid   = validate_input($_POST['tid']);
		
        $query = "INSERT INTO result (class, year, total_number, s_id,t_id)VALUES ('$class', '$year', '$totalnum', '$sid', '$tid')";
