...
<div class="container">
	<form class="form-horizontal" action="update_result_process.php" method="post">
		<h3><p class="text-info" style="padding: 30px ">Update Result data</br></p></h3>
		
		<div class="form-group">
		  <label class="control-label col-sm-2" for="sid">Student Id</label>
		  <div class="col-sm-6">
			  <input type="text" class="form-control" id="sid" placeholder="Enter Student ID" name="sid" value="<?php echo $_GET['id']?>">
		  </div>
		</div>
		<div class="form-group">
		  ...
		  <select class="form-control"name="$column" id="$column">
			...
			<option value="t_id">Class Teacher</option>
		  </select>
		  </div>
		</div>
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-6">
			  <input type="text" class="form-control" id="$stu_value" placeholder="Enter update value " name="$stu_value" required>
		  </div>
		</div>
