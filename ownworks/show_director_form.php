            ...
            <div class="bg-dark dk" id="wrap" style="padding-bottom:50px;">
                <div id="top">
					...
					<header class="head">
                            ...
                            <div class="main-bar">
                                <h3>
									<center><i class="fa fa-square-o"></i>&nbsp;Show Director Info </center>
                                </h3>
                            </div>
                            <!-- /.main-bar -->
                        </header>
		...
		while($row = mysqli_fetch_array($response)){
			...
			echo '<tbody>
					<tr class="">
					  ...
					  ?>
					  <td><a href="delete_director.php?name=<?php echo $row['name'];?>"><button type="button" class="btn btn-danger">Delete</button></a></td>
					  <td><a href="update_director_form1.php?name=<?php echo $row['name']?>"><button type="button" class="btn btn-info">Update</button></a></td>
					</tr>
				</tbody>
				<?php
		}
