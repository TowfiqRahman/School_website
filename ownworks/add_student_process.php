...
if(isset($_POST['submit'])){
        ...
        $edu_year    = validate_input($_POST['edu_year']);
        $address     = validate_input($_POST['address']);
        $s_classno   = validate_input($_POST['s_classno']);
        $contact_no  = validate_input($_POST['contact_no']);
        
        $query = "INSERT INTO student (id, f_name, l_name, sex,
        father_name, mother_name, b_date, edu_year, address, s_classno, 
		contact_no)VALUES ('$id', '$f_name', '$l_name', '$sex',
        '$father_name', '$mother_name', '$b_date', '$edu_year', '$address', '$s_classno', 
		'$contact_no')";
		$query1 = "INSERT INTO result (class, year, s_id)VALUES ('$s_classno', '$edu_year', '$id')";
