...
<div class="container">
	<form class="form-horizontal" action="search_teacher_process.php" method="post">
		
		<h3><p class="text-info"style="padding:30px">Search Teacher by ID First name Last Name....
								</p></h3>
		...
		<div class="form-group">
		  ...
		  <select class="form-control"name="$column" id="$column">
			...
			<option value="assistant_teacher">Assitant Teacher</option>
		  </select>
		  </div>
		</div>
