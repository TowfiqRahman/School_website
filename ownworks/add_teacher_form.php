                    ...
                    <div class="outer">
                        <div class="inner bg-light lter">
                            <div class="container">
								...
								<form class="form-horizontal" action="add_teacher_process.php" method="post">
									...
									<div class="form-group">
									  ...
									  <select class="form-control"name="$column" id="$column">
										...
										<option value="headmaster">Headaster</option>
									...
									<div class="form-group">
									  <label class="control-label col-sm-2" for="head_id">Headmaster Id</label>
									  <div class="col-sm-6">
										  <input type="text" class="form-control" id="head_id" placeholder="Enter data" name="head_id" required>
									  </div>
									</div>
