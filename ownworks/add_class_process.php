...
if(isset($_POST['submit'])){
        $classno     = validate_input($_POST['classno']);
        $roomno      = validate_input($_POST['roomno']);
        $section     = validate_input($_POST['section']);
        $classt_id   = validate_input($_POST['classt_id']);
        
        $query = "INSERT INTO class (classno, roomno, section, classt_id)VALUES ('$classno', '$roomno', '$section', '$classt_id')";
