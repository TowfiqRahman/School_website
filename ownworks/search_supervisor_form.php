            ...
            <div class="bg-dark dk" id="wrap" style="padding-bottom:50px;">
                <div id="top">
					...
					<header class="head">
                            ...
                            <div class="main-bar">
                                <h3>
									<center><i class="fa fa-square-o"></i>&nbsp;Search Supervisor Info</center>
                                </h3>
                            </div>
                            <!-- /.main-bar -->
                        </header>
...
<div class="container">
	<form class="form-horizontal" action="search_supervisor_process.php" method="post">
		<h3><p class="text-info"style="padding:30px"><b>Search Class by Class No,Room No, Section....</b>
								</p></h3>
		...
		<div class="form-group">
		  ...
		  <select class="form-control"name="$column" id="$column">
			...
			<option value="director_name">Supervisor/Director Name</option>
		  </select>
		  </div>
		</div>
