...
<div class="container">
	<form class="form-horizontal" action="search_class_process.php" method="post">
		
		<h3><p class="text-info"style="padding:30px">Search Class Info</p></h3>
		...
		<div class="form-group">
		  ...
		  <select class="form-control"name="$column" id="$column">
			...
			<option value="classt_id">Class Teacher Id</option>
		  </select>
		  </div>
		</div>
