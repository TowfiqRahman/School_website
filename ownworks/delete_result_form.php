            ...
            <div class="bg-dark dk" id="wrap" style="padding-bottom:50px;">
                <div id="top">
					...
					<header class="head">
                            ...
                            <div class="main-bar">
                                <h3>
									<center><i class="fa fa-square-o"></i>&nbsp;Delete Result Info </center>
                                </h3>
                            </div>
                            <!-- /.main-bar -->
                        </header>
				...
				<div id="content">
                    <div class="outer">
						...
						<div class="container">
						<!-- form start-->
							<form class="form-horizontal" action="delete_result_process.php" method="post">
								<h3><p class="text-info"style="padding:30px">Delete Result Info*
								</p></h3>
								
								<div class="form-group">
								  <label class="control-label col-sm-2" for="class">Class:</label>
								  <div class="col-sm-6">
									  <input type="text" class="form-control" id="class" placeholder="Enter Class 1,2,.." name="class" required>
								  </div>
								</div>
								<div class="form-group">
