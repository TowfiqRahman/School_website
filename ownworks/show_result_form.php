...
<div class="container">
	<form class="form-horizontal" action="show_result_process.php" method="post">
	<h3><p class="text-success"style="padding:30px">Show Result Data
	</p></h3>
		

		<div class="form-group">
		  <label class="control-label col-sm-2" for="class">Select Class:</label>
		  <div class="col-sm-6">
