            ...
            <div class="bg-dark dk" id="wrap" style="padding-bottom:50px;">
                <div id="top">
					...
					<header class="head">
                            ...
                            <div class="main-bar">
                                <h3>
									<center><i class="fa fa-square-o"></i>&nbsp;Show Teacher Qualification Info </center>
                                </h3>
                            </div>
                            <!-- /.main-bar -->
                        </header>
...
// If the query executed properly proceed
	if($response){
		...
		<div class="table-responsive">
				...
				<thead>';?>
				  <tr class="active" >
					...
					<th align="center"><b>Degrees</b></th>
		...
		while($row = mysqli_fetch_array($response)){
			...
			echo '<tbody>
					<tr class="">
					  <td align="left">' . $row['teach_id'] . '</td>
					  <td align="left">' . $row['qualification'] . '</td>'
					?>
					<td align="left"><a href="delete_qualification.php?id=<?php echo $row['teach_id'];?>"><button type="button" class="btn btn-danger">Delete</button></a></td>
					 <td align="left"><a href="update_qualification_form1.php?id=<?php echo $row['teach_id']?>"><button type="button" class="btn btn-info">Update</button></a></td>
					 </tr>
				</tbody>
				<?php
		}
