            ...
            <div class="bg-dark dk" id="wrap" style="padding-bottom:50px;">
                <div id="top">
					...
					<header class="head">
                            ...
                            <div class="main-bar">
                                <h3>
									<center><i class="fa fa-square-o"></i>&nbsp;Data Show Page </center>
                                </h3>
                            </div>
                            <!-- /.main-bar -->
                        </header>
				...
				<div id="content">
                    <div class="outer">
						...
						<h2><center><p class="text-success">Welcome to data show service.</br>
								</p></center>
						</h2>
						<h3><center><p class="text-important">Select the required data table form below to show data. 
								</p></center>
						</h3>
						</div>
					   <!--/row-->
