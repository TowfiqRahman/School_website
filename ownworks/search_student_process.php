...
if(isset($_POST['submit'])){
	...
	$query = "SELECT id, f_name, l_name, sex,
        father_name, mother_name, b_date, edu_year, address, s_classno, 
		contact_no FROM student where $col  LIKE '%$value%' ";
		...
		<div class="table-responsive">
				...
				<thead>
				  <tr class="active" >
					...
					<th align="center"><b>Mother Name</b></th>
					<th align="center"><b>Birth Date</b></th>
					<th align="center"><b>Edu. Year</b></th>
		...
		while($row = mysqli_fetch_array($response)){
			...
			echo '<tbody>
					<tr><td align="center">' . $row['id'] . '</td>
					  ...
					  <td align="left">' . $row['mother_name'] . '</td>
					  <td align="center">' . $row['b_date'] . '</td>
					  <td align="center">' . $row['edu_year'] . '</td>
					  <td align="center">' . $row['address'] . '</td>
					  <td align="center">' . $row['s_classno'] .'</td>
