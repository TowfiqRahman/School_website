            ...
            <div class="bg-dark dk" id="wrap" style="padding-bottom:50px;">
                <div id="top">
					...
					<header class="head">
                            ...
                            <div class="main-bar">
                                <h3>
									<center><i class="fa fa-square-o"></i>&nbsp;Delete Dependents Info </center>
                                </h3>
                            </div>
                            <!-- /.main-bar -->
                        </header>
				...
				<div id="content">
                    <div class="outer">
						...
						<div class="container">
							<form class="form-horizontal" action="delete_dependents_process.php" method="post">
								<h3><p class="text-info"style="padding:30px">Delete Dependents Info*
								</p></h3>
