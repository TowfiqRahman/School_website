            ...
            <div class="bg-dark dk" id="wrap" style="padding-bottom:50px;">
                <div id="top">
					...
					<header class="head">
                            ...
                            <div class="main-bar">
                                <h3>
									<center><i class="fa fa-square-o"></i>&nbsp;Add  Dependents Info </center>
                                </h3>
                            </div>
                            <!-- /.main-bar -->
                        </header>
                    ...
                    <div class="outer">
                        <div class="inner bg-light lter">
                            <div class="container">
								...
								<form class="form-horizontal" action="add_dependents_process.php" method="post">
									<div class="form-group">
									  <label class="control-label col-sm-2" for="t_id">Teacher ID:</label>
									  <div class="col-sm-6">
										  <input type="text" class="form-control" id="t_id" placeholder="Enter Teacher ID of the Dependent" name="t_id" required>
									  </div>
									</div>
									...
									<div class="form-group">
									  ...
									  <div class="col-sm-6">
										  <input type="text" class="form-control" id="relation" placeholder="Enter Relation" name="relation" required>
									  </div>
									</div>
