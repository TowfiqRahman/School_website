            ...
            <div class="bg-dark dk" id="wrap" style="padding-bottom:50px;">
                <div id="top">
					...
					<header class="head">
                            ...
                            <div class="main-bar">
                                <h3>
									<center><i class="fa fa-square-o"></i>&nbsp;Update  Class Info </center>
                                </h3>
                            </div>
                            <!-- /.main-bar -->
                        </header>
...
<div class="container">
	<form class="form-horizontal" action="update_class_process.php" method="post">
	<h3><p class="text-info"style="padding:30px">Update Class data</p></h3>
		
		
		<div class="form-group">
		  <label class="control-label col-sm-2" for="classno">Class :</label>
		  <div class="col-sm-6">
			  <input type="text" class="form-control" id="classno" placeholder="Enter Class 1,2,.." name="classno" value="<?php echo $_GET['class']?>">
		  </div>
		</div>
		<div class="form-group">
		  <label class="control-label col-sm-2" for="section">Section:</label>
		  <div class="col-sm-6">
			  <input type="text" class="form-control" id="section" placeholder="Enter Section A,B,C.." name="section" value="<?php echo $_GET['section']?>">
		  </div>
		</div>
		<div class="form-group">
		  ...
		  <select class="form-control"name="$column" id="$column">
			...
			<option value="classt_id">Class Teacher</option>
		  </select>
		  </div>
		</div>
		...
		<div class="form-group">
		  ...
		  <div class="col-sm-6">
			  <input type="text" class="form-control" id="$stu_value" placeholder="Enter Room no or Class Teacher Id" name="$stu_value" required>
		  </div>
		</div>
