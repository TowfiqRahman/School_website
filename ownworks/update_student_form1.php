...
<div class="container">
	<form class="form-horizontal" action="update_student_process.php" method="post">
		<h3><p class="text-info" style="padding: 30px ">Update Student data</br></p></h3>
		...
		<div class="form-group">
		  ...
		  <select class="form-control"name="$column" id="$column">
			...
			<option value="s_classno"> Student Present Class</option>
